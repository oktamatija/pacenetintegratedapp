...
files_to_sync = [
    ('d:\\App\\M.yunus\\mikhmon\\settings\\vps_resource_api.php', '/var/www/mikhmon/settings/vps_resource_api.php'),
    ('d:\\App\\M.yunus\\mikhmon\\settings\\vps_resource.php', '/var/www/mikhmon/settings/vps_resource.php'),
    ('d:\\App\\M.yunus\\mikhmon\\admin.php', '/var/www/mikhmon/admin.php'),
...
stdin, stdout, stderr = ssh.exec_command("chown -R nginx:nginx /var/www/mikhmon && chmod 755 /var/www/mikhmon/settings/vps_resource_api.php /var/www/mikhmon/settings/vps_resource.php")
