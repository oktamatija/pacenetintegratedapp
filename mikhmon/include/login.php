  ...
  <div class="card">
    ...
    <div class="card-body">
      <div class="text-center pd-5">
        <img src="img/hotspot-yunus.png" alt="Hotspot Yunus Logo" style="max-width: 140px; height: auto; border-radius: 50%;">
      </div>
      <div  class="text-center">
      <span style="font-size: 22px; font-weight: 800; margin: 10px; color: #2ecc71; letter-spacing: 0.5px;">PACENET BILLING SYSTEM</span>
      </div>
      <center>
