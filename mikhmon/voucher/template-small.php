<table class="voucher" style=" width: 160px;">
  <tbody>
    <tr>
      <td style="text-align: left; font-size: 13px; font-weight:bold; border-bottom: 1px black solid; padding-bottom: 2px;">
        <div><?php echo $hotspotname;?><span id="num"><?php echo " [$num]";?></span></div>
        <div style="font-size: 10px; font-weight:bold; color: #111;">+62 813-4401-0045</div>
      </td>
    </tr>
    <tr>
      <td>
